...
LightKitAdminUserDataService::registerRealistByRequestId
================



LightKitAdminUserDataService::registerRealistByRequestId — Registers the plugin to the realist service.
...
public [LightKitAdminUserDataService::registerRealistByRequestId](https://github.com/lingtalfi/Light_Kit_Admin_UserData/blob/master/doc/api/Ling/Light_Kit_Admin_UserData/Service/LightKitAdminUserDataService/registerRealistByRequestId.md)(string $requestId) : mixed
