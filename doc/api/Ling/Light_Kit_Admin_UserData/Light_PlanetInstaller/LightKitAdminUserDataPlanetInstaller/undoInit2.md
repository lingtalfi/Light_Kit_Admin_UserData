...
LightKitAdminUserDataPlanetInstaller::undoInit2
================



LightKitAdminUserDataPlanetInstaller::undoInit2 — Undoes the init 2 phase.
...
Source Code
===========
See the source code for method [LightKitAdminUserDataPlanetInstaller::undoInit2](https://github.com/lingtalfi/Light_Kit_Admin_UserData/blob/master/Light_PlanetInstaller/LightKitAdminUserDataPlanetInstaller.php#L69-L106)
...
Previous method: [init2](https://github.com/lingtalfi/Light_Kit_Admin_UserData/blob/master/doc/api/Ling/Light_Kit_Admin_UserData/Light_PlanetInstaller/LightKitAdminUserDataPlanetInstaller/init2.md)<br>
